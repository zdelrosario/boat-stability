...
def fun_performance(X, num=30):
    ...
    Returns:
        df: Performance characteristics
            mass (lb): boat mass
            GM (in): Metacentric height
            BM (in): Metacentric radius
            angle (rad): Angle of vanishing stability
            dMdtheta_0 (lbf in / rad): Moment curve slope, at upright
            dMdtheta_avs (lbf in / rad): Moment curve slope, at avs
            M_max (lbf in): Maximum moment
